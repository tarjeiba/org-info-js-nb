  ...
  build: function ()
  {
    ...
    for(var i = 0; i < this.SECS.length; ++i)
    {
      ...
      var html = '<table class="org-info-js_info-navigation" width="100%" border="0" style="border-bottom:1px solid black;">'
        ...
        + this.LINKS
        +'<a accesskey="m" href="javascript:org_html_manager.toggleView('+i+');">skift visning</a></span>'
...
#+ORGTBL: SEND Shortcuts orgtbl-to-generic :splice t :skip 2 :lstart "\t+'<tr>" :lend "</tr>'" :fmt (1 "<td><code><b>%s</b></code></td>" 2 "<td>%s</td>") :hline "\t+'</tbody><tbody>'"
      | Tast      | Funksjon                                             |
      |-----------+------------------------------------------------------|
      | ?         | vis denne hjelpeskjermen                             |
      |-----------+------------------------------------------------------|
      |           | <b>Flytte rundt</b>                                  |
      | n / p     | gå til neste / forrige delkapittel                   |
      | N / P     | gå til neste / forrige kapittel                      |
      | t / E     | gå til første / siste delkapittel                    |
      | g         | gå til delkapittel...                                |
      | u         | gå opp et nivå                                       |
      | i / C     | vis innholdsfortegnelse / indeks                     |
      | b / B     | gå tilbake til siste / neste besøkte delkapittel     |
      | h / H     | gå til hovedindeks for dette kapittelet / «hjemme»   |
      |-----------+------------------------------------------------------|
      |           | <b>Visninger</b>                                     |
      | m / x     | endre mellom informativ og enkel visning / slides    |
      | f / F     | brett sammen gjeldende visning / vis hele dokumentet |
      |-----------+------------------------------------------------------|
      |           | <b>Søking</b>                                        |
      ...
      |-----------+------------------------------------------------------|
      |           | <b>Ymse</b>                                          |
      | l / L / U | vis HTML-lenke / Org-lenke / vanlig-URL              |
      | v / V     | scroll oppgver / nedover                             |
      | W         | print                                                |
      */
	...
	+'<tr><td><code><b>?</b></code></td><td>vis denne hjelpeskjermen</td></tr>'
	+'</tbody><tbody>'
	+'<tr><td><b>Flytte rundt</b></td></tr>'
	+'<tr><td><code><b>n / p</b></code></td><td>gå til neste / forrige delkapittel</td></tr>'
	+'<tr><td><code><b>N / P</b></code></td><td>gå til neste / forrige kapittel</td></tr>'
	+'<tr><td><code><b>t / E</b></code></td><td>gå til første / siste delkapittel</td></tr>'
	+'<tr><td><code><b>g</b></code></td><td>gå til delkapittel...</td></tr>'
	+'<tr><td><code><b>u</b></code></td><td>gå opp et nivå</td></tr>'
	+'<tr><td><code><b>i / C</b></code></td><td>vis innholdsfortegnelse / indeks</td></tr>'
	+'<tr><td><code><b>b / B</b></code></td><td>gå tilbake til siste / neste besøkte delkapittel</td></tr>'
	+'<tr><td><code><b>h / H</b></code></td><td>gå til hovedindeks for dette kapittelet / «hjemme»</td></tr>'
	+'</tbody><tbody>'
	+'<tr><td><b>Visninger</b></td></tr>'
	+'<tr><td><code><b>m / x</b></code></td><td>endre mellom informativ og enkel visning / slides</td></tr>'
	+'<tr><td><code><b>f / F</b></code></td><td>brett sammen gjeldende visning / vis hele dokumentet</td></tr>'
	+'</tbody><tbody>'
	...
	+'<tr><td><code><b>l / L / U</b></code></td><td>vis HTML-lenke / Org-lenke / vanlig-URL</td></tr>'
	+'<tr><td><code><b>v / V</b></code></td><td>scroll oppgver / nedover</td></tr>'
